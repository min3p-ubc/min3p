...
!> $URL: https://min3psvn.ubc.ca/svn/min3p_thcm/branches/dsu_new_add_2024Jan/src/phase_class/tools/F01brf.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!C     .. Local Scalars ..
      ...
      INTEGER           I, I1, IEND, II, IPRIV4, ISAVE, J, J1, J2,    & 
                        JAY,JJ, KNUM, LENGTH, MOVE, NADV, NERR,       &
                        NEWJ1,NEWPOS
!C     .. Local Arrays ..
...
!C     .. External Subroutines ..
      EXTERNAL          F01BRQ, F01BRR, F01BRT, F01BRY, F01BRZ,       &
