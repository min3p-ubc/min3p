...
!> $URL: https://min3psvn.ubc.ca/svn/min3p_thcm/branches/dsu_new_add_2024Jan/src/phase_class/tools/F04axz.F90 $
!---------------------------------------------------------------------
!********************************************************************!

      SUBROUTINE F04AXZ(N,ICN,A,LICN,LENR,LENRL,LENOFF,IDISP,IP,IQ,   &
                       X,W,MTYPE,RESID)
...
!C     .. Local Scalars ..
      ...
      INTEGER           I, IB, IBACK, IBLEND, IBLOCK, IEND, IFIRST,   &
                        II,III, ILAST, J, J1, J2, J3, JJ, JPIV,       &
                        JPIVP1, K, LJ1, LJ2, LT, LTEND, NUMBLK
      LOGICAL           NEG, NOBLOC
