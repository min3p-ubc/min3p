...
!> $URL: https://min3psvn.ubc.ca/svn/min3p_thcm/branches/dsu_new_add_2024Jan/src/phase_class/tools/xmlreader/m_reader.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
! 
!
character(len=1024)  :: str     ! previous length is 40, change it to 1024 so it is consistent with other variables
                                ! (1 extra for added newline, see below)
integer            :: len
!
read(unit=fb%lun,iostat=iostat,advance="no",size=len,fmt="(a)") str
