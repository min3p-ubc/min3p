...
!> $URL: https://min3psvn.ubc.ca/svn/min3p_thcm/branches/dsu_new_add_2024Jan/src/min3p/aratemin.F90 $
!---------------------------------------------------------------------
!********************************************************************!

!c ----------------------------------------------------------------------
!c subroutine aratemin
!c -------------------
!c
...
!c  monod terms
            ...
            if (istop2.ge.istart2) then
              ...
              do i1 = istart2,istop2
                ...
                ratem =  ratem * ((totcinc(ic,tid)/(fmdm(i1) +        &
                         totcinc(ic,tid)))**ordmdm(i1) - (totc(ic)/   &
