...
!> $URL: https://min3psvn.ubc.ca/svn/min3p_thcm/branches/dsu_new_add_2024Jan/src/min3p/rategas.F90 $
!---------------------------------------------------------------------
!********************************************************************!

!c ----------------------------------------------------------------------
!c subroutine rategas
!c ------------------
!c
...
!c ----------------------------------------------------------------------
      ...
      subroutine rategas(g,tkel,hhead,zg,sg_loc,tid)
 
      use parm
      use chem
      use bbls
      use gen, only : gacc, rank, b_enable_output
