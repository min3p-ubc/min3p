...
!> $URL: https://github.com/min3p-ubc/min3p/blob/main/src/usg/infcrt_a_usg.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c --------------------------------------------------------------------------
      ...
      use gen, only :                                                  &
                     ...
                     comp_dep_diff_coff, type_tortuosity, harmonic_porosity,&
                     ...
                     num_crossdifficv_max, tkel, xg, zg,               &
